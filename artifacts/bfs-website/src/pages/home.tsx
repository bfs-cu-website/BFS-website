...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      ...
      {/* STATS SECTION */}
      <section className="py-16 relative z-20 mx-4 md:mx-auto container rounded-xl shadow-xl shadow-primary/5 opacity-[1] mb-[0px] ml-[0px] mr-[0px] mt-[-40px] bg-[#cdd9fa]">
