...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      ...
      {/* STATS SECTION */}
      <section className="py-16 relative z-20 mx-4 md:mx-auto container rounded-xl shadow-xl shadow-primary/5 -mt-10 bg-[#cdd9fa] ml-[13px] mr-[13px]">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-bold text-accent tracking-widest uppercase mb-3 text-[15px]">Who We Are</h2>
